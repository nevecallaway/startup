  ...
  return (
    <main>
      ...
      <section>
        ...
        <button type="button" onClick={toCommission} className="small-link">Request a Commission</button>
        <button type="button" onClick={toAbout} className="small-link">Learn More</button>
